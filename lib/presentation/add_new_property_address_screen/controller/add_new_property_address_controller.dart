...
import 'package:sakny/presentation/add_new_property_address_screen/models/add_new_property_address_model.dart';
...
class AddNewPropertyAddressController extends GetxController {
  ...
  onSelected(dynamic value) {
    ...
    addNewPropertyAddressModelObj.value.dropdownItemList.forEach((element) {
