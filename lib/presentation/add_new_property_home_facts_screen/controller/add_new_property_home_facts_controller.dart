...
import 'package:sakny/presentation/add_new_property_home_facts_screen/models/add_new_property_home_facts_model.dart';
...
class AddNewPropertyHomeFactsController extends GetxController {
  ...
  onSelected(dynamic value) {
    ...
    addNewPropertyHomeFactsModelObj.value.dropdownItemList.forEach((element) {
